                ...
                <div class="box-body table-responsive no-padding">
                    ...
                    <input type="hidden" name="integration_type">
                        <table width="40%" height="100" border='1' align="center" class="table table-striped table-hover table-bordered">
                            ...
                            <tr>
                                <td>Billing Name  :</td><td><input type="text" class="form-control"  name="billing_name" value="{{old('billing_name')}}"   placeholder="Enter Name" /></td>
                            </tr>
                            <tr>
                                <td>Billing Address :</td><td><input type="text" class="form-control"  name="billing_address" value="{{old('billing_address')}}" placeholder="Enter Address" /></td>
                            </tr>
                            <tr>
                                <td>Billing City  :</td><td><input type="text" class="form-control"  name="billing_city" value="{{old('billing_city')}}" placeholder="Enter City"  /></td>
                            </tr>
                            <tr>
                                <td>Billing State :</td><td><input type="text" class="form-control"  name="billing_state" value="{{old('billing_state')}}" placeholder="Enter State" /></td>
                            </tr>
                            <tr>
                                <td>Billing Zip :</td><td><input type="text" class="form-control"  name="billing_zip" value="{{old('billing_zip')}}" placeholder="Enter Zipcode"/></td>
                            </tr>
                            <tr class="hide">
                                <td>Billing Country :</td><td><input type="hidden" class="form-control"  name="billing_country" value="India"/></td>
                            </tr>
                            <tr>
                                <td>Billing Tel :</td><td><input type="text" class="form-control"  name="billing_tel" value="{{old('billing_tel')}}" placeholder="Enter Mobile number"  /></td>
                            </tr>
                            <tr>
