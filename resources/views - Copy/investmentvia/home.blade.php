...
<!--Slider-->
<section class="rev_slider_wrapper text-center" style="width:100%; height: 100%">            
  ...
  <div class="over-content wow fadeInUp" data-wow-delay="300ms"">
    ...
    <div class="main-btn"> 
        <button style="
                ...
                font-weight: bold;
                background: #07bfd5;
                border: 0px;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
                    Free Trial
        </button> 
    </div>
...
<div class="slideout">
    <a href="#"> <img src="{{ asset('storage/assets/images/watsapp.png')}}" alt="" class="fximg"> </a>
  <div class="slideout_inner">
    +91-{{$contact_number or '8982890444' }}
  </div>
</div>
 
<!-- <div class="paytm wow fadeInUp" data-wow-delay="300ms"""> -->
	<!-- <a href="#"><img src="images/paytm.png" alt=""></a> -->
<!-- </div> -->
<div class="">
