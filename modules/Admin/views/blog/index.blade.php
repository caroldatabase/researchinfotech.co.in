                            ...
                            <div class="row">
                                <div class="box">
                                    <div class="box-header">
                                        ...
                                        <div class="row">
                                            <form action="{{url('admin/blog')}}" method="get" id="filter_data">
                                         ...
                                         <div class="col-md-2">
                                             <a href="{{ url('admin/blog') }}">   <input type="submit" value="Reset" class="btn btn-default form-control"> </a>
                                        </div>
                                        ...
                                        <div class="col-md-2 pull-right">
                                            <div style="width: 150px;" class="input-group"> 
                                                <a href="{{ route('blog.create')}}">
                                                    <button class="btn  btn-primary"><i class="fa fa-user-plus"></i> Create Blog</button> 
                                                </a>
                                            </div>
                                        </div> 
                                    </div><!-- /.box-header -->
<hr>
                                   ...
                                   <div class="box-body table-responsive no-padding" >
                                    ...
                                    <div class="center" align="center">  {!! $blog->render() !!}</div>
                                </div>
                            </div>
                        </div>
                    </div>
